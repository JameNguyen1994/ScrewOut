...
{
    /// <summary>
    /// The Settings object contains an array of options which allows you to customize your use of GameAnalytics. Most importantly you will need to fill in your Game KeyUnlockBox and Secret KeyUnlockBox on the Settings object to use the service.
    /// </summary>
    ///
