...
namespace GameAnalyticsSDK.Editor
{
    ...
    public class GA_SettingsInspector : UnityEditor.Editor
    {
        ...
        private GUIContent _publicKeyLabel = new GUIContent("Game KeyUnlockBox", "Your GameAnalytics Game KeyUnlockBox - copy/paste from the GA website.");
        private GUIContent _privateKeyLabel = new GUIContent("Secret KeyUnlockBox", "Your GameAnalytics Secret KeyUnlockBox - copy/paste from the GA website.");
        ...
        private GUIContent _enableSDKInitEvent  = new GUIContent("Enable SDK InitUI Event (boot time on Android, iOS)", "Enable the SDK InitUI Event to automatically track the boot time (time from application launch to the GameAnalytics SDK initialization)");
        ...
        private GUIContent _account = new GUIContent("Account", "This tab allows you to easily create a GameAnalytics account. You can also login to automatically retrieve your Game KeyUnlockBox and Secret KeyUnlockBox.");
