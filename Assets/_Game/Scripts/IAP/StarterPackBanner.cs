...
public class StarterPackBanner : IBillingBanner
{
    ...
    public override void Init()
    {
        ...
        purchaseHandler = new BuyItemStarterHandler();
        itemData = new IAPItemData()
        {
            iapKey = productId,
            data = new List<ResourceData>
            {
                new ResourceData { value = 1000, resourceType = ResourceType.Coin },
    ...
    public void OnBuyBtnClicked()
    {
        ...
        InAppPurchase.Instance.BuyProduction(productId, "StarterPack" ,OnPurchaseError);
    }
