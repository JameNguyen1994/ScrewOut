    ...
    public class AppLovinIntegrationManagerWindow : EditorWindow
    {
        ...
        private void DrawQualityServiceSettings()
        {
            ...
            using (new EditorGUILayout.VerticalScope("box"))
            {
                ...
                AppLovinSettings.Instance.SdkKey = DrawTextField("AppLovin SDK KeyUnlockBox", AppLovinSettings.Instance.SdkKey, GUILayout.Width(PrivacySettingLabelWidth), _privacySettingFieldWidthOption);
                GUILayout.BeginHorizontal();
                GUILayout.Space(4);
